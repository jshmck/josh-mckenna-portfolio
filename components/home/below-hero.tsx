  ...
  return (
    <>
      ...
      {/* Clients — moved here from the Info page per Josh, directly below
          ...
          entirely by #home-work's pt-10 ("close the gap between clients
          and the work nav pill," per Josh — was pb-16 + pt-16). */}
      <section>
      ...
      <section id="home-work">
        <div className="mx-auto max-w-frame px-6 pb-32 pt-10 md:px-gutter">
