  ...
  return (
    <>
      ...
      {/* Clients — moved here from the Info page per Josh, directly below
          ...
          entirely by #home-work's top padding. Josh-tuned over three
          rounds: pb-16 + pt-16 (128px) → 40px → 24px, which then read
          too tight on desktop ("somewhere between last attempt and this
          one") — so desktop holds 32px and mobile keeps the 24px it was
          signed off at. Desktop's value is the literal default with a
          max-md override, per the mobile-scoping rule. */}
      <section>
      ...
      <section id="home-work">
        <div className="mx-auto max-w-frame px-6 pb-32 pt-8 max-md:pt-6 md:px-gutter">
